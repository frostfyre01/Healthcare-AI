<template>
    <v-container>
      <div class="text-Left">
        <div class="text-body-4 font-weight-light mb-n1 page-title"><v-icon>mdi-zodiac-cancer</v-icon>&nbsp;Data Analysis</div>
        <h2 class="text-h4 font-weight-black">Data-Driven Analysis of Stock Trading Strategies</h2>
        <hr/>
        <br/>
      </div>
